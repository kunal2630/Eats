...
const RestaurantCard = (props) => {
  ...
  return (
    <div
      className="w-[280px]
    min-[400px]:w-[340px]  min-[450px]:w-[400px] min-[500px]:w-[190px]  min-[550px]:w-[223px] min-[600px]:w-[235px] min-[650px]:w-[260px] md:w-[200px] min-[900px]:w-[240px] lg:w-[200px] min-[1245px]:w-[250px]  m-3 min-[1260px]:m-4 rounded-2xl shadow-xl  hover:scale-105 ease-in-out duration-300 "
    >
      <img
